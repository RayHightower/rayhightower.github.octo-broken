...
Finally, open up a web browser on your local machine and navigate to [http://127.0.0.1:1337](http://127.0.0.1:1337). You should see a bare-bones web page similar to this one.
