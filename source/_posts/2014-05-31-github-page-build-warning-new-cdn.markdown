...
This blog is based on Octopress and hosted on GitHub Pages. Recently, when I deployed a site update, GitHub sent me an email with a `GitHub Page Build Warning` message. Since this was _just a warning_, I ignored it while I attacked more pressing tasks (not always a good idea).
